...
// tmp/typed-grammar.hera
var require_typed_grammar = __commonJS({
  "tmp/typed-grammar.hera"(exports) {
    "use strict";
    var {
      $C,
      $E,
    ...
    var $L0 = $L("a");
    var Rule$0 = $TV($EXPECT($L0, 'Rule "a"'), function($skip, $loc, $0, $1) {
      return "ok";
    });
    function Rule(ctx, state) {
...
// tmp/typed-grammar.ts
var typed_grammar_exports = {};
__export(typed_grammar_exports, {
  parse: () => import_typed_grammar.parse
});
module.exports = __toCommonJS(typed_grammar_exports);
var import_typed_grammar = __toESM(require_typed_grammar());
